...
// Les 8 temps de l'indicatif (dans l'ordre logique)
const tempsOptions = [
...
<template>
  <div class="formation-exercise-card">
    ...
    <div class="question-section">
      <p class="instruction">Identifiez le temps du verbe conjugué dans cette phrase :</p>
