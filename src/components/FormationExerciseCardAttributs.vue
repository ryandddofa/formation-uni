...
// Les 2 types d'attributs
const attributsOptions = [
  { value: 'attribut du sujet', label: 'Attribut du sujet' },
  { value: 'attribut du complément direct', label: 'Attribut du complément direct' }
]
...
<template>
  <div class="formation-exercise-card">
    ...
    <div class="question-section">
      <p class="instruction">Identifiez le type d'attribut dans cette phrase :</p>
      <div class="sentence">{{ currentQuestion?.sentence }}</div>
    </div>

    <!-- Options de réponse -->
    <div class="answers-section attributs">
      <button
        v-for="option in attributsOptions"
        :key="option.value"
